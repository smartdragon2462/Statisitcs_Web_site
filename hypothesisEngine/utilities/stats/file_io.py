...
def generate_folders_and_files():
    ...
    if not path.isdir(path.join(params['FILE_PATH'], params['TIME_STAMP'])):
        makedirs(path.join(params['FILE_PATH'], params['TIME_STAMP']))

    params['FILE_PATH'] = path.join(params['FILE_PATH'],  params['TIME_STAMP'])
