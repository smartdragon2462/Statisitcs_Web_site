...
from hypothesisEngine.utilities.stats.file_io import generate_folders_and_files
                ...
                if special_ops == "fitness":
                    ...
                    if len(split_name) > 1:
                        ...
                        try:
                            ...
                            # Get module name.
                            module_name ="hypothesisEngine."+ ".".join(split_name[:-1])
                            ...
                            # Get module name.
                            module_name ="hypothesisEngine."+ ".".join([special_ops,
                                                    ".".join(split_name[:-1])])
                        ...
                        ( op == 'SEARCH_LOOP' or op == 'STEP' ) :
                            ...
                            module_name ="hypothesisEngine."+ ".".join([special_ops, multiagent_ops[op.lower()]])
                            attr_name = split_name[-1]

                        else:
                            # Get module and attribute names.
                            module_name = "hypothesisEngine."+".".join([special_ops, op.lower()])
                            attr_name = split_name[-1]
...
def get_fit_func_imports():
    ...
    if isinstance(params[op], list):
        ...
        for i, name in enumerate(params[op]):
            ...
            # Get module and attribute names.
            module_path = "hypothesisEngine."+ ".".join(['fitness', name.strip()])
            attr = split_name[-1]
        ...
        from hypothesisEngine.fitness.base_ff_classes.moo_ff import moo_ff
        ...
        # Get module name.
        module_name = "hypothesisEngine."+ ".".join(["fitness", params[op]])
